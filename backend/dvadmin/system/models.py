...
#     username = models.CharField(max_length=150, unique=True, db_index=True, verbose_name="用户名称",
#                                 help_text="用户名称")
#     userid = models.CharField(max_length=150, unique=True, db_index=True, verbose_name="用户id",
#                                 help_text="用户id")
#     location = models.CharField(max_length=150, unique=True, db_index=True, verbose_name="存储地址",
#                                 help_text="存储地址")
#     text = models.CharField(max_length=150, unique=True, db_index=True, verbose_name="二维码内容",
#                                 help_text="二维码内容")
#     class Meta:
#         db_table = table_prefix + "qrcode"
#         verbose_name = "二维码信息"
#         verbose_name_plural = verbose_name
#         ordering = ("-create_datetime",)
